...
def run_part1_own_data_split(n_components_pca=None, visualize=False):
    ...
    model_save_path = os.path.join(base_path, "models", f"part_1_own_data_split_logistic_regression_model{model_suffix}_{pd.Timestamp.now().strftime('%Y%m%d_%H%M%S')}.joblib")
...
if __name__ == "__main__":
    run_part1_own_data_split(n_components_pca=0.95, visualize=True)